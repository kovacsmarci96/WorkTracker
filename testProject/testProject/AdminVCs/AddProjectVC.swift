...
class AddProjectViewController: UIPresentationController {
    ...
    override func containerViewWillLayoutSubviews() {
        ...
        presentedView?.roundConrers([.topLeft, .topRight], radius: 22)
    }
...
extension UIView {
    func roundConrers(_ corners: UIRectCorner, radius: CGFloat) {
